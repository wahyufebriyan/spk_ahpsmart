...
function gantiEskul($id) {
	include('config.php');

	// ganti eskul
	$query = "UPDATE user SET hasil=$id WHERE nisn='$_SESSION[nisn]'";
    $result = mysqli_query($koneksi, $query);
...
function showTabelPerbandingan($jenis,$kriteria) {
	...
	<table class="ui celled selectable red table">
		<thead>
			<tr>
	...
	?>
			<tr>
				<td>
					<div class="field">
						<input type="radio">
							<input name="pilih<?php echo $urut?>" value="" checked="" class="hidden" type="radio">
				...
				<td>
					<div class="field">
						<input type="radio">
							<input name="pilih<?php echo $urut?>" value="" class="hidden" type="radio">
	...
	<br><br><input class="ui green submit button" type="submit" name="submit" value="SUBMIT">
	</form>
